...
function eventos()
{
    ...
    {
        ReportePDF(dataClientes);
    });

    $('#reportePDF1').click(function()
    {
        ReportePDF1(dataPedidos);
    });

    $('#reportePDF2').click(function()
    {
        ReportePDF2(dataDetallePedidos);
    });
}
